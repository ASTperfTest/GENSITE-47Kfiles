...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\sys\wsxd2\xdLP2.asp"

'--------- (可修改)要檢查的 request 變數名稱 --------
genParamsArray=array("ctNode", "ctunit", "mp", "xq_xCat", "xq_xCat2", "xq_bCat", "xq_bDept", "CtNode", "data_base_id", "CtUnit", "BaseDSD", "KMautoID", "category_id", "KMAutoID", "memID", "gstyle", "debug", "pagesize", "nowPage")
...
sc="select distinct realname,money from (SELECT name,money, (RANK() OVER (PARTITION BY name ORDER BY money DESC )) as rno FROM flashgame  )as a, member as b where a.rno=1 and a.name=b.account order by money desc"
