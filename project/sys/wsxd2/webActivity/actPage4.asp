...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\sys\wsxd2\webActivity\actPage4.asp"
...
%>
  ...
  <ul class="function">
    ...
    <li class="now"><a href="/sp.asp?xdURL=webActivity/actPage4.asp&mp=<%=mp%>&id=<%=activityId%>">活動說明</a></li>
    <li><a href="/sp.asp?xdURL=webActivity/actPage5.asp&mp=<%=mp%>&id=<%=activityId%>">登入參加問卷調查</a></li>
  </ul>
		
				<div class="content">
					<h4>活動說明</h4>
					<p><strong class="red01">本活動需登入會員方可參加，每位會員限參加一次</strong>。請您先使用您的會員帳密進行登入，若尚未加入會員，請先加入會員。</p>
		
					<h5 class="red01">step 1. 請先註冊成會員</h5>
					<p>若您為第一次參加，請先<a href="http://kmbeta.coa.gov.tw/sp.asp?xdURL=coamember/member_Join.asp&mp=1" target="_blank">註冊成為農業知識入口網的會員</a>。</p>
					<a href="http://kmweb.coa.gov.tw/sp.asp?xdURL=coamember/member_Join.asp&mp=1" target="_blank"><img src="xslgip/style1/images2/flow.gif" alt="馬上註冊" border="0"/></a>
		
					<h5 class="red01">step 2. 使用註冊帳密來登入</h5>
					<p>請使用您的會員帳密來登入。登入後就可以參加問卷調查了。</p>
		
		      <div class="space"></div>
					<br/><br/>
		<center><a href="/sp.asp?xdURL=webActivity/actPage5.asp&mp=<%=mp%>&id=<%=activityId%>"><img src="/xslGip/style1/images2/activity_go.gif" border="0" /></a></center>
				</div>				
			</div>			
		</td>
<%		
