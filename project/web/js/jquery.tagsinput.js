...
(function($) {
    ...
    $.fn.tagsInput = function(options) {
        ...
        var settings = jQuery.extend({
            ...
            width: '500px',
            height: '100px',
            autocomplete_url: '/subject/tags_autocomplete.aspx',
            autocomplete: { selectFirst: false, width: '100px', autoFill: false, extraParams: { membid: membid} },
            'hide': true,
            'delimiter': ',',
            'unique': true,
