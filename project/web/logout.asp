...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\web\logout.asp"
...
<%
	...
	'----作為傳給主題館參數用
	subjecturl= session("myWWWSite") & "/logout.asp"
%>   
	<script language="javascript">
  	alert("登出成功!!");
	$.post("<%=subjecturl %>","",""); // 主題館也要登出
    window.location = "AspxSession.aspx?type=logout&redirecturl=<%=request.querystring("redirecturl")%>";
  </script>  
