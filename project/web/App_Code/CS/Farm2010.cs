...
public class Farm2010
{
    private SqlCommand cmd;
    private SqlDataReader dr;
    private string _login_id = "";
    private string _game_key = "";
    private ILog log4 = LogManager.GetLogger("Farm2010");
	
    public Farm2010(string login_id, string game_key)
    {
    ...
    public int account_id
    {
        get
        {
            ...
            string sql = "SELECT id FROM farm2010_account WHERE login_id = @LOGIN_ID";

            using (SqlConnection conn = FarmDB.create2010Connection())
            {
    ...
    private Hashtable game_status
    {
        get
        {
            ...
            string sql = "SELECT TOP 1 current_round, current_level FROM farm2010_question_data WHERE account_id = @ACCOUNT_ID ORDER BY current_round DESC, current_level DESC";
    ...
    public int isValidKey
    {
        get
        {
            ...
            string sql_check_key = "SELECT * FROM farm2010_account WHERE login_id=@LOGIN_ID AND game_key=@GAME_KEY";
                ...
                try
                {
                    ...
                    using (SqlDataReader dr = cmd_update.ExecuteReader())
                    {
                        if (dr.Read())
                        {
                            ...
                            {
                                sql = "UPDATE farm2010_account SET game_key=@GAME_KEY, realname=@REAL_NAME, nickname=@NICK_NAME, last_modify=@LAST_MODIFY WHERE id=@ID";
                        ...
                        else
                        {
                            // 無資料，寫入
                            dr.Close();
                            sql = "INSERT INTO farm2010_account(login_id, game_key, create_time, realname, nickname, email) ";
    ...
    {
        string sql = "INSERT INTO farm2010_account_log(account_id, action, ip_address, create_time) ";
    ...
    {
        return (_key == MD5(_login_id + Farm2010Config.SALT + _game_key));
    }
    ...
    public string getQuestion(int level, int count)
    {
        ...
        string sql = "SELECT TOP (@COUNT) * FROM farm2010_questions WHERE qrank=@LEVEL and disable=0 ORDER BY NEWID()";
    ...
    public int updateGameData(string _current_round, string _current_level, string _current_score, string _current_timer)
    {
        ...
        if (isValidLevel(_current_level))
        {
            ...
            {
                // 先檢查是否有重複資料
                string sql_check_duplicate = "SELECT id FROM farm2010_question_data WHERE current_round = @CURRENT_ROUND AND current_level = @CURRENT_LEVEL AND account_id = @ACCOUNT_ID";
                ...
                try
                {
                    ...
                    using (SqlCommand cmd_chk = new SqlCommand())
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(sql, conn))
                        {
                            ...
                            {
                                // update
                                sql = "UPDATE farm2010_question_data SET current_score = @CURRENT_SCORE, current_timer = @CURRENT_TIMER ";
                            ...
                            {
                                // insert
                                sql = "INSERT INTO farm2010_question_data(account_id, current_level, current_score, current_timer, create_time, current_round) ";
    ...
    public void updateQuestionLog(int data_id, int question_order, int question_id, int is_correct)
    {
        ...
        {
            string sql = "INSERT INTO farm2010_question_log(data_id, question_id, question_order, is_correct, create_time) ";
    ...
    public string getGameData()
    {
        ...
        string sql_current = "SELECT SUM(current_score) as total_score, SUM(current_timer) as total_timer FROM farm2010_question_data ";
        ...
        using (SqlConnection conn = FarmDB.create2010Connection())
        {
            using (cmd = new SqlCommand())
            {
                ...
                if (Convert.ToInt32(current_game_status["current_level"]) == 3)
                {
                    ...
                    sql_best_score += "FROM farm2010_question_data ";
                ...
                {
                    string sql = "SELECT nickname, realname FROM farm2010_account WHERE id = @ID";
    ...
    public string getTopScore(int count)
    {
        ...
        using (SqlConnection conn = FarmDB.create2010Connection())
        {
            ...
            sqlPersonal.Append(" FROM farm2010_account AS account INNER JOIN ");
            ...
            sqlPersonal.Append(" SELECT MIN(id) as game_data_id, account_id, MAX(current_level) AS max_level, SUM(current_score) AS total_score, SUM(current_timer) AS total_timer FROM farm2010_question_data GROUP BY account_id, current_round ");
            ...
            using(SqlCommand cmd_all = new SqlCommand())
            {
                ...
                //sqlString.Append(" FROM farm2010_account AS account INNER JOIN ");
                ...
                //sqlString.Append(" SELECT account_id, MAX(current_level) AS max_level, SUM(current_score) AS total_score, SUM(current_timer) AS total_timer FROM farm2010_question_data GROUP BY account_id, current_round ");
                ...
                // 2010.11.16 fixed by eddie
                sqlString.Append(" SELECT TOP (@COUNTER) account.id, account.login_id, account.realname, account.nickname, game_data.top_level, game_data.top_score, game_data.top_timer ");
                sqlString.Append(" FROM farm2010_account account, ");
                sqlString.Append(" ( ");
                ...
                sqlString.Append(" FROM farm2010_question_data  ");
                ...
                sqlString.Append(" FROM farm2010_question_data q_data ");
    ...
    private string getGameTimer(int account_id, int top_level, int top_score)
    {
        ...
        using (SqlConnection conn = FarmDB.create2010Connection())
        {
            using(SqlCommand cmd_all = new SqlCommand())
            {
                ...
                sb.Append(" FROM farm2010_question_data GROUP BY account_id, current_round) AS derivedtbl_1 WHERE (account_id = @ACCOUNT_ID) AND (max_level = @MAX_LEVEL) AND (total_score = @MAX_SCORE)");
    ...
    private int getPersonalRank(int the_account_id)
    {
        ...
        sql += " FROM farm2010_account AS account INNER JOIN ";
        ...
        sql += " FROM farm2010_question_data ";
    ...
    private bool isValidDataId(int data_id)
    {
        ...
        using (SqlConnection conn = FarmDB.create2010Connection())
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT id FROM farm2010_question_data WHERE id=@DATA_ID");
