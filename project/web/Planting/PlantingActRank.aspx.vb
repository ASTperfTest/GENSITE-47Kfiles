...
Partial Class Planting_PlantingActRank
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Try
      ...
      sqlString = "SELECT r.UID, r.SCORE, r.STARS AS STAR ,"
      sqlString &= " g.NICKNAME, g.REALNAME "
      sqlString &= " from LBG_GUEST g , LBG_SCORE_RANKING r where r.UID = g.UID order by r.SCORE DESC , r.STARS DESC"
      ...
      If Total <> 0 Then
        ...
        If PageNumber > 1 Then
          PreviousLink.NavigateUrl = "/Planting/PlantingActRank.aspx?PageNumber=" & PageNumber - 1 & "&PageSize=" & PageSize
        Else
          PreviousText.Enabled = False
        End If
        If PageNumberDDL.SelectedValue < PageCount Then
          NextLink.NavigateUrl = "/Planting/PlantingActRank.aspx?PageNumber=" & PageNumber + 1 & "&PageSize=" & PageSize
        Else
  ...
  Function GetSuccessPlantCount(ByVal uid As String) As String
    ...
    Try
      ...
      sqlString &= " ) and n.TOID = s.UID and STATUS = 4"
  ...
  Function CheckCertification(ByVal uid As String) As String
    ...
    Try
      ...
      sqlString &= " (select UID from LBG_GUEST g where g.UID=@uid "
      sqlString &= " and g.STAR >= 6 ) and n.TOID = s.UID and STATUS = 4"
