...
Partial Class myknowledgeActivity_discuss_lp
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
	...
	If ActivityFlag Then 
		TabText.Text &= "<li ><a href=""/knowledge/myknowledgeActivity_question_lp.aspx"">我的活動發問</a></li>" & _
						"<li class=""current""><a href=""/knowledge/myknowledgeActivity_discuss_lp.aspx"">我的活動討論</a></li>"
	End If
    ...
    If Not Page.IsPostBack Then
      ...
      Catch ex As Exception
        If Request.QueryString("debug") = "true" Then
          ...
          Response.End()
        End If
        Response.Redirect("/knowledge/myknowledgeActivity_discuss_lp.aspx")
        Response.End()
      End Try
    Else
    ...
    Try
      ...
      sqlString &= "AND (CodeMain.codeMetaID = 'KnowledgeType') AND (CuDTGeneric_1.siteId = @siteid) AND (KnowledgeForum_1.Status = 'N') AND (KnowledgeForum.Status = 'N') AND ( CuDTGeneric_1.fCTUPublic = 'Y' )"
      ...
      If Total <> 0 Then
        ...
        If PageNumber > 1 Then
          ...
          PreviousLink.NavigateUrl = "/knowledge/myknowledgeActivity_discuss_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
        ...
        If PageNumberDDL.SelectedValue < PageCount Then
          ...
          NextLink.NavigateUrl = "/knowledge/myknowledgeActivity_discuss_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
                                 "&Keyword=" & Web.HttpUtility.UrlEncode(Keyword) & "&Sort=" & Sort & "&PageNumber=" & PageNumber + 1 & "&PageSize=" & PageSize
        Else
  ...
  End Sub
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        ...
        Response.Redirect("/knowledge/myknowledgeActivity_discuss_lp.aspx?keyword=" & keyword)
