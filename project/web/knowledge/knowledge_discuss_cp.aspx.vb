...
Partial Class knowledge_discuss_cp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("memID") = "" Or Session("memID") Is Nothing Then
            If Request("type") = "1" Then
                Script1 = "<script>alert('連線逾時或尚未登入，請登入會員');window.location.href='/knowledge/knowledge_cp.aspx?ArticleId=" & HttpUtility.UrlEncode(Request("ArticleId")) & "&ArticleType=" & HttpUtility.UrlEncode(Request("ArticleType")) & "&CategoryId=" & HttpUtility.UrlEncode(Request("CategoryId")) & "&kpi=" & HttpUtility.UrlEncode(Request("kpi")) & "';</script>"
        ...
        Try
            ...
            If myReader.Read() Then
                ...
                QuestionText.Text &= "<div class=""problem"">" & ReplaceAndFindKeyword(myReader("xBody").replace(Chr(13), "<br />")) & "&nbsp;</div>"
            ...
            If myReader.Read() Then
                ...
                sb.Append("</ul>")
                sb.Append("<p>" & ReplaceAndFindKeyword(myReader("xBody").replace(Chr(13), "<br />")) & "</p>")
        ...
        Try
            ...
            'Response.write (DArticleId & "<br/>")
            'Response.write (WebConfigurationManager.AppSettings("KnowledgeOpinionCtUnitId") & "<br/>")
            ...
            If Total <> 0 Then
                ...
                For i = 0 To 2
                    ...
                    End If
                    sb.Append("</li>")
                    'added by Joey,2009/09/21
                    'sb.Append("<li><a href=""#"" onclick=""window.showModalDialog('http://kmweb.coa.gov.tw/mailbox.asp?');return false;"">檢舉這則意見</a></li>")

                    sb.Append("<p>" & ReplaceAndFindKeyword(myDataRow("xBody").replace(Chr(13), "<br />")) & "</p></div>")
  ...
  Protected Sub ConfirmBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ConfirmBtn.Click
    ...
    End Try
        ...
        Dim reDirectURL As String = "/knowledge/knowledge_discuss_cp.aspx?ArticleId=" & ArticleId & "&DArticleId=" & DArticleId & "&ArticleType=" & ArticleType & "&CategoryId=" & CategoryId
        '發送通知訊息
        KnowledgeNoticeMessage.SendMessage(ArticleId, MemberId, ArticleContent, reDirectURL)
        Dim SuccessScript As String = "<script>alert('發表意見成功');window.location.href='" & reDirectURL & "';</script>"
