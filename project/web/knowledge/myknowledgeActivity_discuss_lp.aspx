<%@ Page Language="VB" MasterPageFile="~/3RSideMasterPage.master" AutoEventWireup="false" CodeFile="myknowledgeActivity_discuss_lp.aspx.vb" Inherits="myknowledgeActivity_discuss_lp" title="農業知識入口網-農業知識家" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <td class="center">
    ...
    <uc2:TabText ID="TabText1" runat="server" />
	  ...
	  <!--path star (style B)-->
	  <div class="path">目前位置：<a href="/knowledge/knowledge.aspx">首頁</a>&gt;<a href=""#"">我的活動討論</a></div>
	  <!--path end-->
	  ...
	  <div id="Magazine">
		...
		<div class="Event">
    		...
    		<!--搜尋我的知識/開始 -->
			<div class="mysearch">
			    <label for="textfield">搜尋我的討論：</label>
