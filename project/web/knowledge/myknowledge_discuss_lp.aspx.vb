...
Partial Class myknowledge_discuss_lp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        '-----------------------------------------------------------------------------
        TabText.Text = WebUtility.GetMyAreaLinks(MyAreaLink.myknowledge_discuss_lp)
        '-----------------------------------------------------------------------------
        ...
        If Not Page.IsPostBack Then
            ...
            Catch ex As Exception
                If Request.QueryString("debug") = "true" Then
                    ...
                    Response.End()
                End If
                Response.Redirect("/knowledge/myknowledge_discuss_lp.aspx")
                Response.End()
            End Try
        Else
        ...
        Try
            sqlString = "SELECT DISTINCT KnowledgeForum_1.ParentIcuitem, CuDTGeneric.iCUItem, CuDTGeneric.sTitle, CuDTGeneric.dEditDate, CuDTGeneric.xPostDate, CodeMain.mValue, KnowledgeForum.DiscussCount, "
            ...
            sqlString &= "CodeMain ON CuDTGeneric.topCat = CodeMain.mCode WHERE (CuDTGeneric_1.iCTUnit = @ictunit) AND (CuDTGeneric_1.iEditor = @account) "
            sqlString &= "AND (CodeMain.codeMetaID = 'KnowledgeType') AND (CuDTGeneric_1.siteId = @siteid) AND (KnowledgeForum_1.Status = 'N') AND (KnowledgeForum.Status = 'N') "
            ...
            If Total <> 0 Then
                ...
                If PageNumber > 1 Then
                    ...
                    PreviousLink.NavigateUrl = "/knowledge/myknowledge_discuss_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
                ...
                If PageNumberDDL.SelectedValue < PageCount Then
                    ...
                    NextLink.NavigateUrl = "/knowledge/myknowledge_discuss_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
                                           "&Keyword=" & Web.HttpUtility.UrlEncode(Keyword) & "&Sort=" & Sort & "&PageNumber=" & PageNumber + 1 & "&PageSize=" & PageSize
                Else
                ...
                For i = 0 To PageSize - 1
                    ...
                    sb.Append("<td><a href=""/knowledge/myknowledge_discuss.aspx?ArticleId=" & myDataRow("iCUItem") & "&ArticleType=" & ArticleType & _
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        ...
        Response.Redirect("/knowledge/myknowledge_discuss_lp.aspx?keyword=" & keyword)
