...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <td class="center">
    ...
    <uc2:TabText ID="TabText1" runat="server" />
	  ...
	  <!--path star (style B)-->
	  <div class="path">目前位置：<a href="/knowledge/knowledge.aspx">首頁</a>&gt;<a href=""#"">我反應的問題</a></div>
	  <!--path end-->
      ...
      <div><!--
			  <label>資料篩選：
			    <a href="/knowledge/myknowledge_pedia.aspx?type=A">我的推薦詞彙</a>｜<a href="/knowledge/myknowledge_pedia.aspx?type=B">我的補充解釋</a>
				</label>	-->	      
		  </div>		
      ...
      <asp:Label ID="TableText" runat="server" Text="" />    
    	...
    	<!--搜尋我的知識/開始 -->
			<div class="mysearch">
			  <!--<label for="textfield">搜尋我反應的問題：</label>
