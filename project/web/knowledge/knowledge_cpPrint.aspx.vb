...
Partial Class knowledge_cpPrint
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If myReader.Read() Then
                ...
                sb.Append("<div class=""problem"">" & (myReader("xBody")) & "&nbsp;</div>")
        ...
        Try
            ...
            If Total <> 0 Then
                ...
                For i = 0 To Total
                    ...
                    sb.Append("<li><a href=""#"" onclick=""window.showModalDialog('http://" & Request.Url.Authority & "/mailbox.asp?jDiscuss',self);return false;"">檢舉</a></li>")
                    ...
                    sb.Append(GetPicInfo(myDataRow("iCUItem")))
                    ' End If
