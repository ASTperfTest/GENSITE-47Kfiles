...
Partial Class myknowledge_question_lp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        '-----------------------------------------------------------------------------
	'added by Joey, 問題單回應, 供user檢視問題反應的處理狀況
        TabText.Text = "<ul><li><a href=""/knowledge/myknowledge_record.aspx""><span>我的紀錄</span></a></li>" & _
                       "<li class=""current""><a href=""/knowledge/myknowledge_question_lp.aspx""><span>我的發問</span></a></li>" & _
           ...
           "<li><a href=""/knowledge/myknowledge_QuestionResponse.aspx""><span>我反應的問題</span></a></li>" & _
                   "<li><a href=""/recommand/recommand_Mylist.aspx""><span>我推薦的文章</span></a></li>" & _
                   "<li><a href=""/knowledge/myknowledge_tags.aspx""><span>我的標籤</span></a></li>" & _
                              "<li ><a href=""/knowledge/myknowledge_read.aspx""><span>我的閱讀記錄</span></a></li>" & _
           "<li ><a href=""/knowledge/myknowledge_keep.aspx""><span>我的收藏</span></a></li>"


        'Add by Ivy 2010.4.27 新增活動頁籤 
	...
	'If ActivityFlag Then 
		'TabText.Text &= "<li ><a href=""/knowledge/myknowledgeActivity_question_lp.aspx"">我的活動發問</a></li>" & _
	...
	'-----------------------------------------------------------------------------
        ...
        If Not Page.IsPostBack Then
            ...
            Catch ex As Exception
                If Request.QueryString("debug") = "true" Then
                    ...
                    Response.End()
                End If
                Response.Redirect("/knowledge/myknowledge_question_lp.aspx")
                Response.End()
            End Try
        Else
        ...
        Try
            sqlString = "SELECT CuDTGeneric.iCUItem, CuDTGeneric.fCTUPublic, CuDTGeneric.sTitle, CuDTGeneric.xPostDate, CodeMain.mValue, CuDTGeneric.dEditDate, KnowledgeForum.DiscussCount, "
            sqlString &= "KnowledgeForum.GradeCount, KnowledgeForum.GradePersonCount, KnowledgeForum.BrowseCount, KnowledgeForum.HavePros, CuDTGeneric.topCat "
            ...
            If Total <> 0 Then
                ...
                If PageNumber > 1 Then
                    ...
                    PreviousLink.NavigateUrl = "/knowledge/myknowledge_question_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
                ...
                If PageNumberDDL.SelectedValue < PageCount Then
                    ...
                    NextLink.NavigateUrl = "/knowledge/myknowledge_question_lp.aspx?ArticleType=" & ArticleType & "&CategoryId=" & CategoryId & _
                                           "&Keyword=" & Web.HttpUtility.UrlEncode(Keyword) & "&Sort=" & Sort & "&PageNumber=" & PageNumber + 1 & "&PageSize=" & PageSize
                Else
                ...
                sb.Append("<tr><th scope=""col"">狀態</th><th scope=""col"">問題標題</th><th scope=""col"">知識分類</th><th scope=""col"">建立日期</th><th scope=""col"">更新日期</th>")
                ...
                For i = 0 To PageSize - 1
                    ...
                    ElseIf myDataRow("fCTUPublic") = "N" Then
                        sb.Append("<td><img src=""images/draft.gif"" alt=""draft"" /></td>")
                    ...
                    Else
                        sb.Append("<td><a href=""/knowledge/myknowledge_question_draft.aspx?ArticleId=" & myDataRow("iCUItem") & "&ArticleType=" & ArticleType & _
                                  "&CategoryId=" & CategoryId & "&Keyword=" & Web.HttpUtility.UrlEncode(Keyword) & "&Sort=" & Sort & """><img src=""images/management.gif"" alt=""管理"" border=""0"" /></td>")
                    End If
                    sb.Append("</tr>")
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        ...
        Response.Redirect("/knowledge/myknowledge_question_lp.aspx?Keyword=" & keyword)
