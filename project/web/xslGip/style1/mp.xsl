...
xmlns:hyweb="urn:gip-hyweb-com" version="1.0">
        ...
        <xsl:for-each select="Article">
          ...
          <a>
            <xsl:attribute name="href">
              <xsl:value-of disable-output-escaping="yes" select="xURL" />
            </xsl:attribute>
          ...
          <p>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <a target="_blank" title="閱讀全文">
                  <xsl:attribute name="href">
                    /subject/<xsl:value-of select="xURL" />
                  </xsl:attribute>
                  閱讀全文
                </a>
              </xsl:otherwise>
      ...
      <div class="body">
        <xsl:for-each select="Article">
          ...
          <p>
            <a>
              <xsl:attribute name="href">
                ct.asp?xItem=<xsl:value-of select="@iCuItem" />&amp;ctNode=<xsl:value-of select="../@xNode" />
              </xsl:attribute>
              <xsl:attribute name="title">
      ...
      <ul class="list">
        <xsl:for-each select="Article">
          <li>
            <a>
              <xsl:choose>
                <xsl:when test="@ShowType='3'">
                  <xsl:attribute name="href">
                    <xsl:value-of select="FileDownLoad"/>
                  </xsl:attribute>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:attribute name="href">
            ...
            <xsl:value-of disable-output-escaping="yes" select="PostDate" />
          </li>
        </xsl:for-each>
      </ul>
      <!--more star (style A)-->
  ...
  <xsl:template match="KMDOC">
    ...
    <div class="hotQa">
      ...
      <ul class="function">
        <li id="KA" class="now">
          <a href="javascript:clickKnowledgeButton('KA')">最新發問</a>
        </li>
        <li id="KB">
          <a href="javascript:clickKnowledgeButton('KB')">熱門討論</a>
        </li>
        <li id="KC">
          <a href="javascript:clickKnowledgeButton('KC')">專家補充</a>
        </li>
      </ul>
      <ul class="list">
      ...
      <div class="more">
        <a href="/knowledge/knowledge_lp.aspx?ArticleType=A&amp;CategoryId=">more...</a>
      </div>
      <!--more end-->
    </div>
    ...
    <div class="hotessay">
      ...
      <ul class="function">
        <li id="A" class="now">
          <a href="javascript:clickButton('A')">最新文章</a>
        </li>
        <li id="B">
          <a href="javascript:clickButton('B')">最多人瀏覽</a>
        </li>
        <li id="C">
          <a href="javascript:clickButton('C')"></a>
        </li>
      </ul>
      <ul class="list">
        <div id="tokenId" ></div>
      ...
      <div class="more">
        <a href="/category/categorylist.aspx?CategoryId=&amp;ActorType=000&amp;t=a">more...</a>
      </div>
      <!--more end-->
    </div>
