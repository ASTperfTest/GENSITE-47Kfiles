...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\web\IQGame-forexhibition\forRich.asp"

'--------- (可修改)要檢查的 request 變數名稱 --------
genParamsArray=array("tuneID", "eCount", "examtype", "xSeason", "xCity")
...
DO while  not isArray(IcuitemList) 
        if   IcuitemList="" then _
