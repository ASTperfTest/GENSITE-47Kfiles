<%@ Page Language="C#" MasterPageFile="~/4SideMasterPage.master" AutoEventWireup="true" CodeFile="04_3.aspx.cs" Inherits="TreasureHunt_04_3" %>
...
<p>尋寶有效頁面倒數30秒完畢，若成功獲得寶物，則出現跳出訊息。此畫面出現後，需輸入正確的驗證碼方能取得寶物。(注意:若沒等倒數30秒完就離開頁面，是無法獲得寶物，也不算有效瀏覽文章喔)<br />
 <img src="image/step4.JPG" width="480" height="276" /></p>
<h2>步驟五</h2>
<p>使用者需輸入驗證碼確認取寶，五樣寶物將隨機產生。<br />
  <img src="image/step5.JPG" width="480" height="276" /></p>
<h2>步驟六</h2>
<p>取寶成果列入個人專區與排行榜的紀錄中，可由活動網頁中查詢寶物豆仔的收集成果與抽獎次數。簡單尋寶、取寶、集寶，快來當尋寶高手抽大獎吧！！<br />
  <img src="image/step6.JPG" width="480" height="382" /><br />
</p>
<div id="step"><span class="steptext"><a href="04.aspx">|&lt;&lt;第一頁</a></span> <span class="steptext"><a href="04_2.aspx">&lt;上一頁</a></span> <span class="steptext">第三頁/共四頁</span> <span class="steptext"><a href="04_4.aspx">下一頁&gt;</a></span> <span class="steptext"><a href="04_4.aspx">最末頁&gt;&gt;|</a></span></div>
      </div></td>
  </tr>
</table>
</body>
