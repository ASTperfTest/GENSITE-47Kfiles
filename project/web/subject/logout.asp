...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\web\subject\logout.asp"
...
<%
	...
	'----作為傳給入口網參數用
	kmweburl= session("mykmweb") & "logout.asp"
	kmwebur2 = session("mykmweb") & "AspxSession.aspx?type=logout"

%>   
	<script language="javascript">
  	alert("登出成功!!");
	$.post("<%=kmweburl %>","",""); // 入口網也要登出
	$.post("<%=kmwebur2 %>","",""); // AspxSession也要登出
