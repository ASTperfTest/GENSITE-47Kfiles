...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\web\subject\np.asp"

'--------- (可修改)要檢查的 request 變數名稱 --------
genParamsArray=array("mp", "ctNode")
...
call CheckPoint_BeforeLoadXML(request("mp"), request("ctNode"), request("xItem"))
	...
	xv = oxml.load(session("myXDURL") & "/wsxd/xdnp.asp?mp=" & mp & "&ctNode=" & request("ctNode") & "&memID=" & memID & "&gstyle=" & gstyle)
