...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
				...
				<div class="more">
					<a>
						<xsl:attribute name="href">
							np.asp?ctNode=<xsl:value-of select="@xNode" />&amp;mp=<xsl:value-of select="//hpMain/mp"/>
						</xsl:attribute>
						更多訊息
					</a>
				</div>
	...
	<xsl:template match="//BlockB/Article" mode="Style1">
		<xsl:if test="../IsPic = 'Y'">
			<div class="block">
	...
	<xsl:template match="//BlockB/Article" mode="Style2">
		<td>
			<xsl:if test="../IsPic = 'Y'">
				<xsl:if test="xImgFile">
					<img class="listimg">
	...
	<xsl:template match="//BlockB/Article" mode="Style3">
		...
		<p>
			<xsl:if test="../IsExcerpt ='Y'">
				...
				<xsl:attribute name="href">
					ct.asp?xItem=<xsl:value-of select="@iCuItem" />&amp;ctNode=<xsl:value-of select="../@xNode" />&amp;mp=<xsl:value-of select="//hpMain/mp"/>
				</xsl:attribute>
				詳全文
			</a>&gt;
		</p>
