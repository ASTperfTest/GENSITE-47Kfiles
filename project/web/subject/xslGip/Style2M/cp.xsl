							...
							<td id="center">
								...
								<div class="friendly">
									...
									<div class="email">
										<a>
											<xsl:attribute name="href">
												question_login.asp?mp=<xsl:value-of select="//mp" />|<xsl:value-of select="//MainArticle/@iCuItem"/>|<xsl:value-of select="//MainArticle/@iCuItem"/>
											</xsl:attribute>
											<xsl:attribute name="target">_blank</xsl:attribute>
											我要發問
										</a>
