    ...
    <xsl:template match="hpMain">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
			    ...
			    <!-- 投稿說明／開始 -->
			    <div class="Page"><br/>
			  	  <xsl:if test="//xPath/UnitName='蝴蝶蘭與我'">
					<img src="/xslgip/style01/images/mailus.gif" alt="我要投稿" align="absmiddle" />
					<a href="ct.asp?xItem=6666&amp;ctNode=1415" title="我要投稿">我要投稿</a>
			          </xsl:if>
			    </div>
			    <!-- 投稿說明／結束 -->
                            <!-- 資料大類／開始 -->
