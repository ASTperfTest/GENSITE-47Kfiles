...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:saxon="http://icl.com/saxon/"
    ...
    <xsl:variable name="title">農委會蝴蝶蘭主題館</xsl:variable>
    <!-- 網站標頭／開始 -->
    ...
    <xsl:template match="hpMain" mode="info">
      <link rel="stylesheet" type="text/css">
        ...
        <ul class="TopLink">
            ...
            <li>
                <a title="回首頁"><xsl:attribute name="href">dp.asp?mp=<xsl:value-of select="//mp" /></xsl:attribute>首頁</a>
            </li>
            <li>
                <!--<a title="聯絡我們"><xsl:apply-templates select="." mode="ContactUs" />聯絡我們</a>-->
                <a title="聯絡我們" href="mailto:mailtocoa@gmail.com">聯絡我們</a>
            </li>
            <li>
                <a title="網站導覽"><xsl:attribute name="href">sitemap.asp?mp=<xsl:value-of select="//Mp" /></xsl:attribute>導覽</a>
