...
<!-- BlockF End -->
	...
	<xsl:template match="//BlockF/Article" mode="Style1">
		<xsl:if test="../IsPic = 'Y'">
			<div class="block">		
	...
	<xsl:template match="//BlockF/Article" mode="Style2">
		<td>
			<xsl:if test="../IsPic = 'Y'">		
				<xsl:if test="xImgFile">
					<img class="listimg">
	...
	<xsl:template match="//BlockF/Article" mode="Style3">
