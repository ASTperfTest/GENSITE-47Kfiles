	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			...
			<link rel="stylesheet" type="text/css" >
				<xsl:attribute name="href">/xslgip/<xsl:value-of select="//myStyle"/>/css/rss.css</xsl:attribute>
			</link>		
		</head>
		<body>
		<!-- 網站標題／開始 -->
		...
		<table class="Layout" summary="排版表格">
		  <tr>
				...
				<td class="Center">
					...
					<!-- 單元名稱／開始 -->
					<div class="PageTitle"><xsl:value-of select="RSSTop/Caption"/><!--xsl:value-of select="//CtUnitName"/--></div>
					<!-- 單元名稱／結束 -->
