...
<%
	...
	End If
   	...
   	'response.write "login"  
		'----作為傳給入口網參數用
		kmweburl= session("mykmweb") & "loginact.asp"
		param = "account2=" & account2 & "&passwd2=" & passwd2
		
		Response.Write "<BODY>"
		Response.Write "<form name='myform' id='myform' action='/AspxSession.aspx' method='post' >"
		Response.Write "<input type=""hidden"" name=""redirecturl"" value=""" & O_URL & """ />"
