...
Partial Class Top_20102
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Dim ConnString As String = FarmDB.connString2010
    ...
    Try
            ...
            If Total <> 0 Then
                ...
                If PageNumber > 1 Then
                    PreviousLink.NavigateUrl = "Top_20102.aspx?PageNumber=" & PageNumber - 1 & "&PageSize=" & PageSize
                Else
                    PreviousText.Enabled = False
                End If
                If PageNumberDDL.SelectedValue < PageCount Then
                    NextLink.NavigateUrl = "Top_20102.aspx?PageNumber=" & PageNumber + 1 & "&PageSize=" & PageSize
                Else
  ...
  End Sub
    ...
    Function getGameTimer(ByVal account_id As Integer, ByVal top_level As Integer, ByVal top_score As Integer) As String
        ...
        Dim conn As SqlConnection = FarmDB.create2010Connection()
