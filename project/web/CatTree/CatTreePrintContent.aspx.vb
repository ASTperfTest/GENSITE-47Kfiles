...
Imports System.Xml
Partial Class CatTreePrintContent
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '加上轉址的處理
        Dim transferUrl As String = "/Category/categoryprintcontent.aspx?CategoryId={0}&ActorType={1}&ReportId={2}"
        ...
        Else
            ...
            Else
                If myReader.Read() Then
                    If myReader("LAMBDA_DocId") Is DBNull.Value = False AndAlso String.IsNullOrEmpty(myReader("LAMBDA_DocId")) Then
