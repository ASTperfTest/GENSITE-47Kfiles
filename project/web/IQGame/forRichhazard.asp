...
'目前程式位置在
progPath="D:\hyweb\GENSITE\project\web\IQGame\forRichhazard.asp"

'--------- (可修改)要檢查的 request 變數名稱 --------
genParamsArray=array("eCount")
...
IcuitemList = GethazardItemList(ExamCount)  
