<%@ Page Language="VB" MasterPageFile="~/4SideMasterPage.master" AutoEventWireup="false" CodeFile="MemberRanking2010.aspx.vb" Inherits="MemberRanking2010" title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<a href="#" title="網頁內容資料" class="Accesskey" accesskey="C">:::</a>

	<div class="path">目前位置：<a href="/">首頁</a>&gt;<a href="/Member/MemberRanking2010.aspx">2010會員排行榜</a></div>
	
  <h3>2010會員排行榜 &nbsp;&nbsp;<font color="blue">(統計至2010/11/30 早上10點止)</font></h3>
