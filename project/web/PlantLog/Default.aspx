...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="Server">
    ...
    <div id="content">
        ...
        <p>
            另外為鼓勵會員參與競賽，凡參加競賽活動，且未進入前三名之參賽者，可以參加抽獎活動，獎品如下：</p>
        <ul>
            <li>參加獎壹獎(10名)：8GB隨身碟一個。</li>
			<li>參加獎貳獎(10名)：台灣優質米一包。</li>
        </ul>
        ...
        <ul>
            ...
            <li>好開心獎(3名)：時尚隨身碟一枚。 </li>
            <li>好口福獎(20名)：優質農產伴手禮一份。 </li>
        </ul>
        ...
        <ol>
			...
			<li><span style='color:red;'>票選活動新增email認證機制，每位會員投票時將自動比對會員帳號註冊email，若其他帳號已使用相同email註冊並投票，則該會員之投票將不列入計算。</span></li>
			<li><span style='color:red;'>為維護比賽公平性，禁止會員從事外掛程式等任何影響活動結果，或攻訐他人之行為。<br/>
一經告發查證，主辦單位可刪除其參與活動資格及逕行會員停權作業，該會員之活動行為（如投票票數）將不予採計。
該會員若為得獎者，則獎項將追回，採順位方式候補，不另行通知。本網站將保留相關法律追訴之權利。
</span></li>
			<li><span style='color:red;'>各參賽作品之正式合格票數結果，應以本網站最後公布結果為準。票選結果將於投票活動結束後當週內公布於活動網站。</span></li>
        </ol>
    </div>
