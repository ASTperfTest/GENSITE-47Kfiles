        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
                    ...
                    <Columns>
						<asp:BoundField DataField="VoterId" HeaderText="投票者帳號" HeaderStyle-HorizontalAlign="Left" />
                        <asp:BoundField DataField="VoterName" HeaderText="投票者" HeaderStyle-HorizontalAlign="Left"/>
                        <asp:BoundField DataField="VoteDate" HeaderText="投票時間" HeaderStyle-HorizontalAlign="Left"/>
			<asp:BoundField DataField="IP" HeaderText="IP" HeaderStyle-HorizontalAlign="Left"/>
                    </Columns>
                    ...
                    <EmptyDataTemplate>
                        <asp:Table ID="Table1" runat="server" Width="100%">
                            <asp:TableHeaderRow Width="100%" BackColor="#4A3C8C" Font-Bold="True" ForeColor="#F7F7F7">
                                <asp:TableHeaderCell Text="投票者帳號" />
