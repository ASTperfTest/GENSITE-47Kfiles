<%@ Page Language="VB" MasterPageFile="~/Pedia/PediaMasterPage.master" AutoEventWireup="false" CodeFile="KpiRank.aspx.vb" Inherits="KpiRank_KpiRank" title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

  <a href="#" title="網頁內容資料" class="Accesskey" accesskey="C">:::</a>
	
	<div class="path">目前位置：<a href="/">首頁</a>&gt;<a href="#">會員排行榜</a></div>
  ...
  <h3>會員排行榜</h3>
	...
	<div id="Magazine">
      ...
      <asp:Label ID="TabText" runat="server" Text="" />    
