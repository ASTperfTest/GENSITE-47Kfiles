				...
				<tr>
					<td width="642" height="194" align="right" valign="top" background="xslgip/intra1/images/login_bk_top.jpg">
						<span class="doclink">
							...
							<a href="#" onClick="Javascript:IDQ">忘記密碼</a></span>
						<span class="doclink">
					...
					<td height="100" align="center" valign="middle" bgcolor="#D7F1A1"><strong class="customername"><%=session("mySiteName")%>, 
						...
						<form method="POST" action="checkLogin.asp" name="f1" target="_self" id="f1">
							<table width="250" border="0" cellspacing="1" cellpadding="1">
								...
								<tr align="center">
									<td colspan="2" valign="middle"><input name="Submitb" type="button" class="inputbutton" value="送出" OnClick="Javascript:xsubmit()" />
