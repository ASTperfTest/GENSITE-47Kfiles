...
<UL>
<LI id="s0"><img src="../imageTree/ftv2folderopen.gif" align="absmiddle"/>¸ê®Æ¤W½Z</LI>
...
Function treeImg(nodeList) 
  Set myNode=nodeList(0)
   ...
   for i = 1 to len(leadStr)-1
   	rStr = rStr & "<img src=""../imageTree/t" & mid(leadStr,i,1) & ".gif"" align=""absmiddle""/>"
   next
   if myNode.attributes.getNamedItem("CtNodeKind").value="C" then
	rStr = rStr & "<img id=""pms" & myNode.attributes.getNamedItem("id").value _
		& """ src=""../imageTree/fopen" & right(leadStr,1) & ".gif"" align=""absmiddle""/>"
 	rStr = rStr & "<img src=""../imageTree/ftv2folderclosed.gif"" align=""absmiddle""/>"
  else
	rStr = rStr & "<img id=""pms" & myNode.attributes.getNamedItem("id").value _
		& """ src=""../imageTree/t" & right(leadStr,1) & ".gif"" align=""absmiddle""/>"
 	rStr = rStr & "<img src=""../imageTree/openfold.gif"" align=""absmiddle""/>"
   end if
   treeImg = rStr
End Function
