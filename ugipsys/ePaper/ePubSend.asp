...
If session("epTreeID") = "21" Then
	...
	sql = ""
	sql = sql & " INSERT INTO CuDTGeneric(iBaseDSD,iCTUnit,fCTUPublic,sTitle,iEditor,dEditDate,iDept,xURL,showType,xNewWindow) "
	sql = sql & " VALUES( 7, 1356, 'Y', " & pkStr(eptitle, "") & ", '" & session("userID") & "', GETDATE(), "
	sql = sql & " '" & session("deptID") & "', 'http://kmweb.coa.gov.tw/epaper.asp?eid=" & epubid & "', '2','Y') "
	...
	sql = ""
	sql = "INSERT INTO CuDTx7(giCuItem) VALUES(" & newepaperid & ")"
	conn.execute(sql)
End If	
