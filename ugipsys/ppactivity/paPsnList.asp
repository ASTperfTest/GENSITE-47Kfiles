...
if fSql="" then
	fSql = "SELECT htx.psnID, htx.pName, htx.birthDay, htx.eMail, htx.emergContact, htx.zipcode, htx.tel, htx.myPassword, htx.addr" _
...
if pKey<>"" then  pKey = mid(pKey,2)%>
	<TD class=eTableContent ><A href="paPsnInfoEdit.asp?<%=pKey%>"><%=RSreg("psnID")%></A></td>
	<TD class=eTableContent width=10%><font size=2>
<%=RSreg("pName")%>
</font></td>
