...
<table border="0" width="780" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class=txt height="21" background="../uweb/scifamily/images/bg.gif"  align=center >
  ...
  <tr>
	...
	<TABLE width=100% cellspacing="1" cellpadding="5" class=bg border=0 bgcolor="#9E946A" >                   
		...
		<td>學校或服務單位</td>		
 		<td>住址</td>
 		<td class=lightbluetable>餐食</td>
 		<td class=lightbluetable>備註</td>
		...
		<TD  align=center>
		<font size=2><%=RSreg("emergcontact")%>
		</font></td>	
		<TD  align=center>
		<font size=2><%=RSreg("myOrg")%>
		</font></td>
		<TD  align=center>
		<font size=2><%=RSreg("addr")%>
		</font></td>
	   <TD  align=center>
		<font size=2><%=RSreg("ppsex")%></font></td>
		<TD  align=center>
		<font size=2><%=RSreg("notes")%>
		</font></td>
		</tr>
    		<%
         	RSreg.moveNext
