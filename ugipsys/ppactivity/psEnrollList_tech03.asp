...
<title>九十二年度第二季少年科技創作研習營活動</title>
<style type="text/css">
<!--
...
<body bgcolor="#C4DCA5" text="#000000" background="../uweb/tech/images/bg.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table width="770" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="106"><img src="../uweb/tech/images/cir.gif" width="106" height="94"></td>
          <td align="center"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="670" height="75">
              <param name=movie value="../uweb/tech/images/tit.swf">
              <param name=quality value=high>
              <param name="wmode" value="transparent">
              <embed src="../uweb/tech/images/tit.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="670" height="75" wmode="transparent">
              </embed> 
            </object></td>
        </tr>
      </table>
        ...
        <tr>
          <td align="center"> 
            <table width="700" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="../uweb/tech/images/3.gif" width=100% height="10"></td>
              </tr>
              <tr>
                <td bgcolor="#EDF7E1">
