...
if fSql="" then
	...
	next
	fSql = fSql & " ORDER BY xref1.mSortValue  DESC"
end if
...
.t1      { font-family: "標楷體", "新細明體"; font-size: 16pt; color: #660099; line-height: 180%; letter-spacing: 2pt; font-weight:bold;}
    ...
    <td>
      <table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="center" class=t1>國立自然科學博物館．92年度植物園寒假研習營</td>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
	...
	<table border="0" width="95%" cellspacing="1" cellpadding="0" align="center">
  	 <tr>
		...
		<font size=-1 color=red>      　　　　此名單之順序以身分證字號排列, 並非備取順序.  遞補者將以電話個別通知
	    </td>
  	</tr>
  	<tr>
    ...
    <CENTER>-->
     	<TABLE width=60% cellspacing="1" cellpadding="5" class=bg border=0 bgcolor=336699 border=1>                   
     		<tr align=center>    
