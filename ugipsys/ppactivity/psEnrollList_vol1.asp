...
<title>國立自然科學博物館高中學生公共服務申請</title>
...
<table border="0" width="780" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class=txt height="21" background="../uweb/scifamily/images/bg.gif"  align=center >
  <tr valign=top height=70>
    ...
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="780" height="82" >
      <param name=movie value="../uweb/vol01/images/title_v01.swf">
      <param name=quality value=high>
       <param name="wmode" value="transparent">
      <embed src="../uweb/vol01/images/title_v01.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="780" height="70" wmode="transparent"> 
       </object>
     </td>
  </tr>
  <tr>
    <td width="780" valign="top" height="1" align="left">
       <p style="margin-top: -11; margin-bottom: -6"><img border="0" src="../uweb/vol01/images/line.gif" width="800" height="8">
    </td>
  </tr>
  <tr >
  ...
  <tr >
    <td  valign="top" align="center" background="images/bg.gif"><br>&nbsp;
      <table border="0 width="90%" cellspacing="0" cellpadding="0" align=center height=500 >
        <tr valign=top>
