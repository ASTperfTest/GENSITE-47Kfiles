...
<table border="0" width="780" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class=txt height="21" background="../uweb/kids_workshop/images/bg.gif"  align=center >
  ...
  <tr>
	...
	<TABLE width=100% cellspacing="1" cellpadding="5" class=bg border=0 bgcolor="#9E946A" >                   
		...
		if total < RS("pLimit") or total = RS("pLimit") then 
