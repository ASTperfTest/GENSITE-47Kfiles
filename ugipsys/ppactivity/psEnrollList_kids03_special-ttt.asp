  ...
  <tr>
	...
	<TABLE width=100% cellspacing="1" cellpadding="5" class=bg border=0 bgcolor="#9E946A" >                   
		...
		<td class=lightbluetable>出生年月日</td>
 		...
 		<td class=lightbluetable>家長身份證</td>
 		<td class=lightbluetable>家長生日</td> 		
 		<td class=lightbluetable>連絡電話</td> 		
 		<td class=lightbluetable>同行兒童姓名</td>
		<td class=lightbluetable>同行兒童身份證</td>
		<td class=lightbluetable>同行兒童生日</td>
   		</tr>	
		...
		<TD  align=center>
		<font size=2 title="<%=RSreg("ppName")%>">
		<%=RSreg("ppName")%>
		</font></td>
		<TD  align=center>
		<font size=2 title="<%=RSreg("pParentID")%>">
		<%=RSreg("pParentID")%>
		</font></td>
		<TD  align=center>
		<font size=2 title="<%=RSreg("ppbirth")%>">
		<%=RSreg("ppbirth")%>
		</font></td>	
		<TD  align=center>
		<font size=2 title="<%=RSreg("tel")%>">
		<%=RSreg("tel")%>
		</font></td>		
		<TD  align=center>
		<font size=2 title="<%=RSreg("p2Name")%>">
		<%=RSreg("p2Name")%>
		</font></td>
		<TD  align=center>
		<font size=2 title="<%=RSreg("psn2ID")%>">
		<%=RSreg("psn2ID")%>
		<TD  align=center>
		<font size=2 title="<%=RSreg("p2birth")%>">
		<%=RSreg("p2birth")%>
		</font></td>
		</font></td>
		</tr>
