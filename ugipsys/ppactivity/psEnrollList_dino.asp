...
<title>國立自然科學博物館「飛天恐龍—溯源之謎大解碼」特展研習活動</title>
<style type="text/css">
<!--
    ...
    <tr>
      <td height="44" valign="top" bgcolor="#CCCCCC" align="center">
         <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="780" height="44" >
              <param name=movie value="../uweb/dino/images/title_dino.swf">
              <param name=quality value=high>
              <param name="wmode" value="transparent">
              <embed src="../uweb/dino/images/title_dino.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="780" height="44" wmode="transparent" >
              </embed> 
            </object> 
      </td>
    </tr>
