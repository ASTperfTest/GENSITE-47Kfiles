...
<table width="770" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="767" height="90" vspace="5">
              <param name=movie value="../uweb/peoples/images/title.swf">
              <param name=quality value=high>
              <param name="wmode" value="transparent">
              <embed src="../uweb/peoples/images/title.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="767" height="90" wmode="transparent" vspace="5">
              </embed> 
            </object> 
  ...
  <tr>
    <td>
      <table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <font color="#00FF00"><b><br><br>每個臉譜都叮囑著我們：多元族群衍生的文化，是人類的共同資產<p></b></font>
          </td>
        </tr>
        <tr>
          <td align="center"> 
    ...
    <CENTER>-->
		...
		<!--<td class=lightbluetable>報名日</td>-->
 		<td class=lightbluetable>姓名</td>
		<td class=lightbluetable>學校或服務單位</td>
		<!--<td class=lightbluetable>聯絡電話</td>
		<td class=lightbluetable>緊急聯絡人/Email</td>-->
   		</tr>	                                
		<%                   
    		for i=1 to 130                  
		%>                  
		...
		<%if i<121 then 
			 ...
			 response.write "備取 " & i-120
                end if %>  			 
		</td>
		<!--<TD class=whitetablebg align=center>
		<font size=2 title="<%=xStdTime(RSreg("erDate"))%>"><%=d7Date(RSreg("erDate"))%>
		</font></td>-->
