...
if fSql="" then
	fSql = "SELECT htx.ppsex, htx.p2name, htx.paSID, htx.ckValue, htx.erDate, htx.ppcount, htx.status, htx.psnID AS xPsnID, p.*" _
...
<body topmargin="0" leftmargin="0" bgcolor="#B4D8A5"  >
<table border="0" width="780" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class=txt height="313" background="../uweb/93_history/kids_workshop/images/bg.gif"  align=center >
  <tr valign=top height=70 bgcolor=#336699>
     <td height="94">
      ...
      <param name=movie value="../uweb/93_history/southbeach/images/title1.swf">
      <param name=quality value=high>
       <param name="wmode" value="transparent">
      <embed src="../uweb/93_history/southbeach/images/title1.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="780" height="70" wmode="transparent"> 
       </object>
     
     </td>
  </tr>
  <tr>
    <td width="780" valign="top" height="5" align="left">
       <p style="margin-top: -11; margin-bottom: -6"><img border="0" src="../scifamily/images/line.gif" width="800" height="8">
    </td>
  </tr>
  <tr >
    <td width="780" valign="top" height="22" bgcolor="#006699" align=right>
     <a href=http://enroll.nmns.edu.tw/uweb/pact03eduworkshop.asp>回上一頁</a>
    </td>
  </tr>
  <tr>
    <td  valign="top" align="center" height="192"><br>&nbsp;
      <table border="0 width=" cellspacing="0" cellpadding="0" align=center height=500 >
        <tr valign=top>
