...
'--xxxADD.asp--------------------------
    ...
    Set xfin = fs.opentextfile(Server.MapPath("Template1/TempMDAdd2.asp"))
	dumpTempFile
    xfin.Close

	xfout.writeline ct & "sql = ""INSERT INTO " & htFormDom.selectSingleNode("@ref").text & "("""
    ...
    Set xfin = fs.opentextfile(Server.MapPath("Template1/TempMDFUAdd3.asp"))
	dumpTempFile
    xfin.Close
    xfout.Close
...
sub processInsert(xstr)
	...
	xfout.writeLine ct&ct&"sqlValue = sqlValue & pkStr(xUpForm(""htx_" & refField & """),"","")"
