...
<div id="FormName">
	...
	if session("ctNodeId") = 1572 then%>
		<input type="button" class="cbutton" value="執行匯入" name="buttonImport" onclick="importData()" >
	<%end if%> 
</div>
<!--  條列頁簡易查詢功能  -->
...
%>
<!--Start 2009.07.29 by ivy -->
<script Language=JavaScript>
function importData()
{
	window.open("http://kmwebsys.coa.gov.tw/site/coa/wsxd2/ImportSunupSundown.aspx");
}
</script>
<!--End by ivy -->
