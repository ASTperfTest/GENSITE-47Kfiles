...
<table width="642" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <span class="doclink"><img src="xslgip/intra1/images/forgetpassword.gif" width="28" height="26" align="absmiddle" /> 
    <a href="#" onClick="VBS:IDQ">忘記密碼</a></span> 
    <span class="doclink"><img src="xslgip/intra1/images/relateddoc.gif" width="28" height="26" align="absmiddle" /> 
    <a href="javascript:MM_openBrWindow('document/list.asp','document','scrollbars=yes,resizable=yes,width=488,height=250')">相關操作手冊&nbsp;&nbsp;</a></span></td>
  </tr>
  <tr>
    <td height="100" align="center" valign="middle" bgcolor="#D7F1A1"><strong class="customername"><%=session("mySiteName")%>,
        請輸入使用者資訊</strong><br />
		<form method="POST" action="ccheckLogin.asp" name="f1" target="_self" id="f1" >
      <table width="250" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td width="75" valign="middle"><img src="xslgip/intra1/images/usename.gif" width="70" height="17" /> </td>
          <td align="left"><input name="tfx_userName" type="text" class="inputtext" size="16" /></td>
        </tr>
        <tr>
          <td width="75" valign="middle"><img src="xslgip/intra1/images/password.gif" width="70" height="17" /> </td>
