...
public partial class mGIPcoanewDataContext : System.Data.Linq.DataContext
{
  ...
  partial void InsertBirthdayCardTypeRecord(BirthdayCardTypeRecord instance);
  partial void UpdateBirthdayCardTypeRecord(BirthdayCardTypeRecord instance);
  partial void DeleteBirthdayCardTypeRecord(BirthdayCardTypeRecord instance);
  partial void InsertInvalidURLHeader(InvalidURLHeader instance);
  partial void UpdateInvalidURLHeader(InvalidURLHeader instance);
  partial void DeleteInvalidURLHeader(InvalidURLHeader instance);
  partial void InsertInvalidURLDetail(InvalidURLDetail instance);
  partial void UpdateInvalidURLDetail(InvalidURLDetail instance);
  partial void DeleteInvalidURLDetail(InvalidURLDetail instance);
  partial void InsertBaseDSD(BaseDSD instance);
  partial void UpdateBaseDSD(BaseDSD instance);
  partial void DeleteBaseDSD(BaseDSD instance);
  partial void InsertNodeInfo(NodeInfo instance);
  partial void UpdateNodeInfo(NodeInfo instance);
  partial void DeleteNodeInfo(NodeInfo instance);
  partial void InsertCatTreeRoot1(CatTreeRoot1 instance);
  partial void UpdateCatTreeRoot1(CatTreeRoot1 instance);
  partial void DeleteCatTreeRoot1(CatTreeRoot1 instance);
  partial void InsertPhoneticNotation(PhoneticNotation instance);
  partial void UpdatePhoneticNotation(PhoneticNotation instance);
  partial void DeletePhoneticNotation(PhoneticNotation instance);
  #endregion
	...
	public System.Data.Linq.Table<BirthdayCardTypeRecord> BirthdayCardTypeRecord
	{
		get
		{
			return this.GetTable<BirthdayCardTypeRecord>();
		}
	}
	
	public System.Data.Linq.Table<InvalidURLHeader> InvalidURLHeader
	{
		get
		{
			return this.GetTable<InvalidURLHeader>();
		}
	}
	
	public System.Data.Linq.Table<InvalidURLDetail> InvalidURLDetail
	{
		get
		{
			return this.GetTable<InvalidURLDetail>();
		}
	}
	
	public System.Data.Linq.Table<BaseDSD> BaseDSD
	{
		get
		{
			return this.GetTable<BaseDSD>();
		}
	}
	
	public System.Data.Linq.Table<NodeInfo> NodeInfo
	{
		get
		{
			return this.GetTable<NodeInfo>();
		}
	}
	
	public System.Data.Linq.Table<CatTreeRoot1> CatTreeRoot1
	{
		get
		{
			return this.GetTable<CatTreeRoot1>();
		}
	}
	
	public System.Data.Linq.Table<PhoneticNotation> PhoneticNotation
	{
		get
		{
			return this.GetTable<PhoneticNotation>();
		}
	}
}
...
[Table(Name="dbo.BirthdayCardTypeRecord")]
public partial class BirthdayCardTypeRecord : INotifyPropertyChanging, INotifyPropertyChanged
{
...
[Table(Name="dbo.InvalidURLHeader")]
public partial class InvalidURLHeader : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_runDate", DbType="SmallDateTime NOT NULL")]
	...
	[Column(Storage="_removeDate", DbType="SmallDateTime")]
...
[Table(Name="dbo.InvalidURLDetail")]
public partial class InvalidURLDetail : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_State", DbType="Char(1)")]
	...
	[Column(Storage="_Result", DbType="NVarChar(100)")]
...
[Table(Name="dbo.BaseDSD")]
public partial class BaseDSD : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private string _sBaseTableName;
	
	private string _sBaseDSDName;
	
	private string _tDesc;
	
	private string _rDSDCat;
	
	private char _inUse;
	
	private string _sBaseDSDXML;
    ...
    partial void OniBaseDSDChanging(int value);
    partial void OniBaseDSDChanged();
    partial void OnsBaseTableNameChanging(string value);
    partial void OnsBaseTableNameChanged();
    partial void OnsBaseDSDNameChanging(string value);
    partial void OnsBaseDSDNameChanged();
    partial void OntDescChanging(string value);
    partial void OntDescChanged();
    partial void OnrDSDCatChanging(string value);
    partial void OnrDSDCatChanged();
    partial void OninUseChanging(char value);
    partial void OninUseChanged();
    partial void OnsBaseDSDXMLChanging(string value);
    partial void OnsBaseDSDXMLChanged();
    #endregion
	...
	[Column(Storage="_iBaseDSD", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	public int iBaseDSD
	{
		get
		{
	...
	[Column(Storage="_sBaseTableName", DbType="VarChar(30)")]
	public string sBaseTableName
	{
		get
		{
			return this._sBaseTableName;
		}
		set
		{
			if ((this._sBaseTableName != value))
			{
				this.OnsBaseTableNameChanging(value);
				this.SendPropertyChanging();
				this._sBaseTableName = value;
				this.SendPropertyChanged("sBaseTableName");
				this.OnsBaseTableNameChanged();
			}
		}
	}
	
	[Column(Storage="_sBaseDSDName", DbType="VarChar(40) NOT NULL", CanBeNull=false)]
	public string sBaseDSDName
	{
		get
		{
			return this._sBaseDSDName;
		}
		set
		{
			if ((this._sBaseDSDName != value))
			{
				this.OnsBaseDSDNameChanging(value);
				this.SendPropertyChanging();
				this._sBaseDSDName = value;
				this.SendPropertyChanged("sBaseDSDName");
				this.OnsBaseDSDNameChanged();
			}
		}
	}
	
	[Column(Storage="_tDesc", DbType="VarChar(300)")]
	public string tDesc
	{
		get
		{
	...
	[Column(Storage="_rDSDCat", DbType="VarChar(10)")]
	public string rDSDCat
	{
		get
		{
			return this._rDSDCat;
		}
		set
		{
			if ((this._rDSDCat != value))
			{
				this.OnrDSDCatChanging(value);
				this.SendPropertyChanging();
				this._rDSDCat = value;
				this.SendPropertyChanged("rDSDCat");
				this.OnrDSDCatChanged();
			}
		}
	}
	...
	[Column(Storage="_sBaseDSDXML", DbType="VarChar(100)")]
	public string sBaseDSDXML
	{
		get
		{
			return this._sBaseDSDXML;
		}
		set
		{
			if ((this._sBaseDSDXML != value))
			{
				this.OnsBaseDSDXMLChanging(value);
				this.SendPropertyChanging();
				this._sBaseDSDXML = value;
				this.SendPropertyChanged("sBaseDSDXML");
				this.OnsBaseDSDXMLChanged();
			}
		}
	}
...
[Table(Name="dbo.NodeInfo")]
public partial class NodeInfo : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private string _Logonote;
	
	private System.Nullable<char> _lockRightBtn;
	
	private string _footer_dept;
	
	private string _footer_dept_url;
	
	private System.Nullable<int> _order_num;
	
	private string _subject_user;
	
	private System.Nullable<char> _old_subject;
	
	private string _Keywords;
	
	private bool _CatMemo_Disable;
    ...
    partial void Onpic_titleChanging(string value);
    partial void Onpic_titleChanged();
    partial void Onpic_bannerChanging(string value);
    partial void Onpic_bannerChanged();
    partial void Oncreate_timeChanging(string value);
    partial void Oncreate_timeChanged();
    partial void Onmodify_timeChanging(string value);
    ...
    partial void OnLogonoteChanging(string value);
    partial void OnLogonoteChanged();
    partial void OnlockRightBtnChanging(System.Nullable<char> value);
    partial void OnlockRightBtnChanged();
    partial void Onfooter_deptChanging(string value);
    partial void Onfooter_deptChanged();
    partial void Onfooter_dept_urlChanging(string value);
    partial void Onfooter_dept_urlChanged();
    partial void Onorder_numChanging(System.Nullable<int> value);
    partial void Onorder_numChanged();
    partial void Onsubject_userChanging(string value);
    partial void Onsubject_userChanged();
    partial void Onold_subjectChanging(System.Nullable<char> value);
    partial void Onold_subjectChanged();
    partial void OnKeywordsChanging(string value);
    partial void OnKeywordsChanged();
    partial void OnCatMemo_DisableChanging(bool value);
    partial void OnCatMemo_DisableChanged();
    #endregion
	...
	[Column(Storage="_sub_title", DbType="VarChar(200)")]
	...
	[Column(Storage="_url_link", DbType="VarChar(200)")]
	...
	[Column(Storage="_pic", DbType="VarChar(50)")]
	public string pic
	{
		get
		{
	...
	[Column(Name="abstract", Storage="_abstract", DbType="VarChar(500)")]
	public string @abstract
	{
		get
		{
	...
	[Column(Storage="_type1", DbType="VarChar(20)")]
	public string type1
	{
		get
		{
	...
	[Column(Storage="_pic_title", DbType="VarChar(50)")]
	public string pic_title
	{
		...
		set
		{
			if ((this._pic_title != value))
			{
				this.Onpic_titleChanging(value);
				this.SendPropertyChanging();
				this._pic_title = value;
				this.SendPropertyChanged("pic_title");
				this.Onpic_titleChanged();
			}
		}
	}
	
	[Column(Storage="_pic_banner", DbType="VarChar(50)")]
	public string pic_banner
	{
		get
		{
			return this._pic_banner;
		}
		set
		{
			if ((this._pic_banner != value))
			{
				this.Onpic_bannerChanging(value);
				this.SendPropertyChanging();
				this._pic_banner = value;
				this.SendPropertyChanged("pic_banner");
				this.Onpic_bannerChanged();
			}
		}
	}
	
	[Column(Storage="_create_time", DbType="VarChar(50)")]
	...
	[Column(Storage="_modify_time", DbType="VarChar(50)")]
	...
	[Column(Storage="_list", DbType="VarChar(50)")]
	public string list
	{
		get
		{
	...
	[Column(Storage="_Logo", DbType="NVarChar(50)")]
	public string Logo
	{
		get
		{
	...
	[Column(Storage="_Logonote", DbType="NVarChar(200)")]
	public string Logonote
	{
		get
		{
			return this._Logonote;
		}
		set
		{
			if ((this._Logonote != value))
			{
				this.OnLogonoteChanging(value);
				this.SendPropertyChanging();
				this._Logonote = value;
				this.SendPropertyChanged("Logonote");
				this.OnLogonoteChanged();
			}
		}
	}
	
	[Column(Storage="_lockRightBtn", DbType="Char(1)")]
	public System.Nullable<char> lockRightBtn
	{
		get
		{
			return this._lockRightBtn;
		}
		set
		{
			if ((this._lockRightBtn != value))
			{
				this.OnlockRightBtnChanging(value);
				this.SendPropertyChanging();
				this._lockRightBtn = value;
				this.SendPropertyChanged("lockRightBtn");
				this.OnlockRightBtnChanged();
			}
		}
	}
	
	[Column(Storage="_footer_dept", DbType="NVarChar(200)")]
	public string footer_dept
	{
		get
		{
			return this._footer_dept;
		}
		set
		{
			if ((this._footer_dept != value))
			{
				this.Onfooter_deptChanging(value);
				this.SendPropertyChanging();
				this._footer_dept = value;
				this.SendPropertyChanged("footer_dept");
				this.Onfooter_deptChanged();
			}
		}
	}
	
	[Column(Storage="_footer_dept_url", DbType="NVarChar(200)")]
	public string footer_dept_url
	{
		get
		{
			return this._footer_dept_url;
		}
		set
		{
			if ((this._footer_dept_url != value))
			{
				this.Onfooter_dept_urlChanging(value);
				this.SendPropertyChanging();
				this._footer_dept_url = value;
				this.SendPropertyChanged("footer_dept_url");
				this.Onfooter_dept_urlChanged();
			}
		}
	}
	...
	[Column(Storage="_subject_user", DbType="NVarChar(500)")]
	public string subject_user
	{
		get
		{
			return this._subject_user;
		}
		set
		{
			if ((this._subject_user != value))
			{
				this.Onsubject_userChanging(value);
				this.SendPropertyChanging();
				this._subject_user = value;
				this.SendPropertyChanged("subject_user");
				this.Onsubject_userChanged();
			}
		}
	}
	
	[Column(Storage="_old_subject", DbType="Char(1)")]
	public System.Nullable<char> old_subject
	{
		get
		{
			return this._old_subject;
		}
		set
		{
			if ((this._old_subject != value))
			{
				this.Onold_subjectChanging(value);
				this.SendPropertyChanging();
				this._old_subject = value;
				this.SendPropertyChanged("old_subject");
				this.Onold_subjectChanged();
			}
		}
	}
	
	[Column(Storage="_Keywords", DbType="NText", UpdateCheck=UpdateCheck.Never)]
	...
	[Column(Storage="_CatMemo_Disable", DbType="Bit NOT NULL")]
	public bool CatMemo_Disable
	{
		get
		{
			return this._CatMemo_Disable;
		}
		set
		{
			if ((this._CatMemo_Disable != value))
			{
				this.OnCatMemo_DisableChanging(value);
				this.SendPropertyChanging();
				this._CatMemo_Disable = value;
				this.SendPropertyChanged("CatMemo_Disable");
				this.OnCatMemo_DisableChanged();
			}
		}
	}
...
[Table(Name="dbo.CatTreeRoot")]
public partial class CatTreeRoot1 : INotifyPropertyChanging, INotifyPropertyChanged
{
...
[Table(Name="dbo.PhoneticNotation")]
public partial class PhoneticNotation : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private string _PhoneticNotation1;
	
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnwordChanging(char value);
    partial void OnwordChanged();
    partial void OnPhoneticNotation1Changing(string value);
    partial void OnPhoneticNotation1Changed();
    #endregion
	
	public PhoneticNotation()
	{
		OnCreated();
	}
	
	[Column(Storage="_word", DbType="NVarChar(1) NOT NULL", IsPrimaryKey=true)]
	public char word
	{
		get
		{
	...
	[Column(Name="PhoneticNotation", Storage="_PhoneticNotation1", DbType="NVarChar(4) NOT NULL", CanBeNull=false)]
	public string PhoneticNotation1
	{
		get
		{
			return this._PhoneticNotation1;
		}
		set
		{
			if ((this._PhoneticNotation1 != value))
			{
				this.OnPhoneticNotation1Changing(value);
				this.SendPropertyChanging();
				this._PhoneticNotation1 = value;
				this.SendPropertyChanged("PhoneticNotation1");
				this.OnPhoneticNotation1Changed();
			}
		}
	}
