...
//last updated: 2/03/05 12:09 AM

//warning: anything element in html document that has its id == TOC_CONTAINER_ID
...
function getXML(func) {
	...
	//setRequestHeader(xmlHttpReq, 'Accept-Charset', 'utf-8')
	//custom headers
	/*//(mssqlserver)db.toc@localhost
	setRequestHeader(xmlHttpReq, 'Param-SQLServerType', 'microsoft:sqlserver')
	setRequestHeader(xmlHttpReq, 'Param-Host', 'localhost')
	setRequestHeader(xmlHttpReq, 'Param-Port', '1434')
	setRequestHeader(xmlHttpReq, 'Param-Database', 'db')
	setRequestHeader(xmlHttpReq, 'Param-Table', 'toc')
	setRequestHeader(xmlHttpReq, 'Param-Username', 'maian')
	setRequestHeader(xmlHttpReq, 'Param-Password', null)*/
	/*//(mysql)db.toc@localhost
	setRequestHeader(xmlHttpReq, 'Param-SQLServerType', 'mysql')
	setRequestHeader(xmlHttpReq, 'Param-Host', 'localhost')
	setRequestHeader(xmlHttpReq, 'Param-Port', '3306')
	setRequestHeader(xmlHttpReq, 'Param-Database', 'db')
	setRequestHeader(xmlHttpReq, 'Param-Table', 'toc')
	setRequestHeader(xmlHttpReq, 'Param-Username', 'root')
	setRequestHeader(xmlHttpReq, 'Param-Password', 'password')*/
	/*//(mssqlserver)GIPtcsafe_test.temp@10.10.5.59
	setRequestHeader(xmlHttpReq, 'Param-SQLServerType', 'microsoft:sqlserver')
	setRequestHeader(xmlHttpReq, 'Param-Host', '10.10.5.59')
	setRequestHeader(xmlHttpReq, 'Param-Port', '1433')
	setRequestHeader(xmlHttpReq, 'Param-Database', 'GIPtcsafe_test')
	setRequestHeader(xmlHttpReq, 'Param-Table', 'temp')
	setRequestHeader(xmlHttpReq, 'Param-Username', 'hygip')
	setRequestHeader(xmlHttpReq, 'Param-Password', 'hyweb')*/
