...
<%
   ...
   '	response.write "查詢條件：電氣 ,19750415,19750416<br><br>"
   'x = obj.hyft_addquery(id, "kw", "電氣", "", 0, 1, 0)
   
   'x = obj.hyft_addquery(id, "dd", "19750415", "19750416", 0, 0, 0)
   'x = obj.hyft_addand(id)
    
   'x = obj.hyft_addquery(id, "kw", "777", "", 0, 1, 0)
   'x = obj.hyft_addquery(id, "dd", 19750417, 19750417, 0, 0, 0)
   'x = obj.hyft_addand(id)
   'x = obj.hyft_addor(id)
   query = "專案"
   x = obj.hyft_addquery(id, "", query, "", 0, 0, 0)
   ret = obj.ret_val
   'response.write obj.ret_val
   if ret = -1 then
