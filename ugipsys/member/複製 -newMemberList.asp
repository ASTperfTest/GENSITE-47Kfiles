...
<tr>
	...
	<td align="center"><a href="newMemberEdit.asp?account=<%=trim(RSreg("account"))%>&nowPage=<%=nowPage%>&pagesize=<%=PerPageSize%>"><%=RSreg("account")%></a></td>
	<td align="center"><%=RSreg("realname")%>&nbsp;</td>
	<td align="center"><%=RSreg("email")%>&nbsp;</td>
	<td align="center"><%=RSreg("createtime")%>&nbsp;</td>
	<td align="center">
...
<script Language=VBScript>
    ...
    sub GoPage_OnChange      
		   ...
		   & "&validate=" & reg.validate.value & "&role=" & reg.role.value   
     end sub      
	...
	//end if
	 ...
	 document.location.href="<%=HTProgPrefix%>List.asp?keep=Y&nowPage=<%=nowPage%>&pagesize=<%=PerPageSize%>" _
			& "&role=" & reg.role.value & "&validate=" & reg.validate.value
     end sub	 
