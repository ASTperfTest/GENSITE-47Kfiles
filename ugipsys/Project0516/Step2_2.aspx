<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_2" %>
...
<body>
    ...
    <div class="step">步驟： 1. 填寫基本資料 > <span>2. 設定版面風格</span> > 3. 導覽架構設定 > 4. 首頁配置</div>
    ...
    <td>1. 上傳標題圖片：<br>
        <asp:FileUpload ID="Topic_upload" runat="server" Width="269px" /><br />(建議圖片大小為200 × 35px)<br/><asp:Image ID="Topic_pic" ImageUrl="./images/snap1841.jpg" Width="250" runat="server" Height="40px" /></td>
    </tr>
    <tr>
    ...
    --%><p>>> <a href="./step2_2.aspx" onclick="window.open('new_web_pic.aspx','','width=450,height=200')">【使用自行設計標題】 </a></p>
    </td> 
    </tr>
    </table>
    ...
    --%></div>
    <asp:HiddenField ID="temp_ID" runat="server" />
    </form>
</body>
</html>
