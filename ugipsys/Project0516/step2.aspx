...
<body>
    ...
    <td>1. 上傳標題圖片：<br>
        <asp:FileUpload ID="Topic_upload" runat="server" Width="269px" /><br>(建議圖片大小為200 × 35px)<br><img src="./images/snap1841.jpg" width="250"></td>
    </tr>
    <tr>
    ...
    --%><p>>> <a href="./step2.aspx" onclick="window.open('new_web_pic.aspx','','width=450,height=200')">【使用自行設計標題】 </a></p>
    </td>
    </tr>
    </table>
    ...
    <asp:Button ID="delete" runat="server" Visible="false" Text="刪除主題館" OnClientClick="return confirm('是否刪除?')" OnClick="delete_Click"  />
