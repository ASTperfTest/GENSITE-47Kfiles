...
%>
<form name="form1" method="post" action="CtNodeControl_act.asp" onSubmit="return checkform();">
  ...
  while not RStree.eof
	...
	while not RS.eof
		...
		if RS("CtNodeKind") = "C" then
	     ...
	     sql1 = "select count(*) from CtNodeUser where userId=N'" & userId & "' and ctNodeId=" & rs("ctNodeId")
