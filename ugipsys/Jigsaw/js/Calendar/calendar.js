...
var giYearC = gdCurDate.getFullYear()-1911;
...
function fSetDate(iYear, iMonth, iDay){
  ...
  if ((iYear == 0) && (iMonth == 0) && (iDay == 0)){
  	...
  	gdCtrl.value = iYear+1911+"/"+iMonth+"/"+iDay;
  	if(iYear.length==2)
  	{
  	  	iYear="0"+iYear;
  	} 

  	gdCtrlC.value = iYear+"/"+iMonth+"/"+iDay;
  }
  ...
  window.returnValue=gdCtrl.value+','+gdCtrlC.value;
...
write("<B ID=\"CAL_B_BLANK\" style='color:"+gcBG+"; cursor:hand; font-size:12px' onclick='fSetDate(0,0,0)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'>清空</B>");
write("</td><td algin='center'>");
write("<B style='color:"+gcBG+";cursor:hand; font-size:12px' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'>今日: "+giYearC+"/"+giMonth+"/"+giDay+"</B>");
write("</td></tr></table>");
write("</TD></TR>");
write("</TABLE></Div>");
}
