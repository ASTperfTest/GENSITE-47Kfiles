...
<body>
  ...
  <tr>
	...
	<table cellspacing="0" id="ListTable">
	<caption>登入行為詳細得點記錄</caption>
  <tr>
    <th scope="col">日期</th>
    <th width="14%" colspan="2" scope="col">會員登入 (次數｜得分)</th>
    <th width="14%" colspan="2" scope="col">IQ大挑戰 (次數｜得分)</th>
    <th width="14%" colspan="2" scope="col">虛擬種植 (次數｜得分)</th>
    <th width="14%" colspan="2" scope="col">生日卡片連結登入</th>
    <th width="14%" colspan="2" scope="col">邀請會員給點</th>
    <th width="14%" colspan="2" scope="col">被邀請給點</th>
    <th scope="col" width="12%">周頻率給點</th>
	</tr>
	<%
	if thisyear = "" then
  ...
  <tr>
    <td><%=rs("loginDate")%></td>
    <td><%=rs("loginInterCount")%></td><td><%=rs("loginInterGrade")%></td>
    <td><%=rs("loginIQCount")%></td><td><%=rs("loginIQGrade")%></td>
    <td><%=rs("loginRaiseCount")%></td><td><%=rs("loginRaiseGrade")%></td>
    <td colspan="2"><%=rs("loginBirthdayGrade")%></td>
    <td colspan="2"><%=rs("loginInvite")%></td>
    <td colspan="2"><%=rs("loginIsInvited")%></td>
    <td><%=rs("loginAdditional")%></td>
  </tr>
	<%
		rs.movenext
	wend
