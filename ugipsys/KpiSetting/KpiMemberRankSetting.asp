...
<body>
  ...
  <tr>
		...
		<td width="50%" class="FormLink" align="right"><A href="javascript:window.location.href='/KpiSetting/KpiMemberRankSetting.asp" title="回前頁">回前頁</A></td>	
  </tr>
  <tr>
  ...
  <tr><td class="Formtext" colspan="2" height="15"></td></tr>
	<tr>
		...
		<form method="POST" name="reg" action="KpiMemberRankSetting.asp?id=<%=Rank0%>" ENCTYPE="MULTIPART/FORM-DATA">
		...
		<%
			...
			While not rs.eof 							
				if flag <> rs("Rank0_4") then
					...
					response.write "<TD class=""eTableContent""><input name=""" & rs("Rank0_2") & """ value=""" & rs("Rank0_1") & """ size=""10"">&nbsp;％</TD>" & vbcrlf				
					response.write "</TR>" & vbcrlf			
