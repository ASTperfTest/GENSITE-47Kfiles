...
<body>
	<form method="GET" name="reg" action="KpiMangQueryResult.asp">
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
	  <td width="50%" align="left" nowrap class="FormName">總年度KPI整合管理&nbsp;<font size=2>【查詢】</font></td>
	...
	<tr>
      ...
      <TR>
        ...
        <TD class="eTableContent">
					<a href="/KpiSetting/KpiMemberSummaryExport.asp" target="_blank">產生並匯出會員積分總表</a> (匯出報表前一日統計結果為止)
				</TD>
      </TR>
      </TABLE>
      <TABLE width="100%" id="ListTable">
