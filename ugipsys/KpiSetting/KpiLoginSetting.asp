...
<body>
  ...
  <tr>
		...
		<td width="50%" class="FormLink" align="right"><A href="javascript:window.location.href='/KpiSetting/KpiLoginSetting.asp" title="回前頁">回前頁</A></td>	
  </tr>
  <tr>
  ...
  <tr><td class="Formtext" colspan="2" height="15"></td></tr>
	<tr>
		...
		<form method="POST" name="reg" action="KpiLoginSetting.asp?id=<%=Rank0%>" ENCTYPE="MULTIPART/FORM-DATA">
