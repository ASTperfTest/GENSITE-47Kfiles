<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProsDataDetail.aspx.vb" Inherits="ProsData_ProsDataDetail" %>
...
<body>
    ...
    <form id="Form1" runat="server" name="reg" enctype="multipart/form-data">
        <div>    
          <table  cellspacing="0">
          <tr>
            <td class="Label" align="right">*會員帳號：</td>
            <td class="eTableContent"><asp:TextBox ID="accounttext" runat="server" ReadOnly="true" ></asp:TextBox>限用英文與數字，可用『-』或『_』，30碼以下</td>
          </tr>
          <tr>
            <td class="Label" align="right">*真實姓名：</td>
            <td class="eTableContent"><asp:TextBox ID="realnametext" runat="server" ReadOnly="true"></asp:TextBox></td>
          </tr>
          <tr>
          ...
          <tr>            
			...
			<td class="eTableContent">
			    <asp:TextBox ID="htx_KMcattext" runat="server"></asp:TextBox>
                <asp:HiddenField ID="htx_KMcatIDtext" runat="server" />
                <asp:HiddenField ID="htx_KMautoIDtext" runat="server" />
          ...
          <script language="javascript" type="text/javascript">
           ...
           <asp:Button ID="SubmitBtn" CssClass="cbutton" runat="server" Text="確定修改" OnClientClick="send();" />
           <asp:Button ID="ResetBtn" CssClass="cbutton" runat="server" Text="取消" OnClientClick="back();"/>   
