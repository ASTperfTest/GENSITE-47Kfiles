...
'		msgBox parent.parent.frames("fedit").document.all.tags("SPAN").length
		...
		next
	xStyle=" id="&grid&" style=""border-width:0; border-style:outset; border-color:#999999; background-color:#EEE" & _
		";position:absolute; top:600; left:40; cursor:hand; z-index:0;"">"
'width:300px; height:95px; 
	...
	xImg="<IMG id=vbt" & mid(grid,4) & " src=""bt_updown.gif"" style=""position:absolute; top:185;" _
 		& " left:10;"" title=""拉動調整單元高度"">"
	xHTML = "<SPAN "&xstyle&writeCodeStr&"</SPAN>"
